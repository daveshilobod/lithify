...
from .transforms import rewrite_type_hints_ast
...
def run_generation(cfg: GenerationConfig, r: Reporter) -> GenerationResult:
    ...
    with staging_dir(enabled=use_staging) as stage:
        ...
        with r.task("Preparing schemas..."):
            ...
            validate_schema_consistency(work_json_out, block_remote_refs=cfg.block_remote_refs, base_url=cfg.base_url, verbose=cfg.verbose)
            st.schema_index = SchemaIndex.load(list(work_json_out.rglob("*.json")), cfg.base_url)
