...
"""
Sanitizer and numbered schema tests.
"""
...
from lithify.sanitizer import safe_module_slug, build_filename_map, sanitize_tree, _rewrite_refs, cleanup_temp_dir
...
class TestNumberedSchemas:
    """Test handling of numbered schema files."""
    
    def test_numbered_schemas_generation(self, temp_dir):
        """Test that numbered schemas like 01_user.yaml work correctly."""
...
class TestSanitizer:
    """Test the schema name sanitizer."""
    
    def test_safe_module_slug(self):
        """Test that module slugs are valid Python identifiers."""
    ...
    def test_safe_module_slug_edge_cases(self):
        """Test edge cases for module slug generation."""
    ...
    def test_filename_mapping(self, temp_dir):
        """Test that filename mapping prefers clean names."""
    ...
    def test_filename_mapping_init_file(self, temp_dir):
        """Test handling of __init__.json schema."""
    ...
    def test_rewrite_refs(self, temp_dir):
        """Test $ref rewriting in schemas."""
        name_map = {
            "01_user.json": "user.json",
            "02_audit.json": "audit.json"
        }
    ...
    def test_sanitize_tree_creates_temp_dir(self, temp_dir):
        """Test that sanitize_tree creates a proper temp directory."""
    ...
    def test_sanitize_tree_nested_directories(self, temp_dir):
        """Test sanitize_tree with nested directory structure."""
