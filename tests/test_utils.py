...
class TestFrozenDict:
    """Test FrozenDict implementation."""
    
    def test_frozendict_hashing(self):
        """Test that FrozenDict is hashable and order-independent."""
    ...
    def test_frozendict_nested(self):
        """Test FrozenDict with nested structures."""
...
class TestUtils:
    ...
    def test_write_if_changed_same_content(self, temp_dir):
        """Test writing same content doesn't change file."""
    ...
    def test_write_if_changed_different_content(self, temp_dir):
        """Test writing different content changes file."""
        path = temp_dir / "existing.txt"
